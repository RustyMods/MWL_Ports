...
public static class LocalKeys
{
    ...
    public static readonly string Manifests = new Key("$label_manifest", "Manifests").GetKey();
    ...
    public static readonly string Delivered = new Key("$label_delivered", "Delivered").GetKey();
